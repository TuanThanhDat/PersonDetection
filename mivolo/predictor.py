...
class Predictor:
    def __init__(self, verbose: bool = False, device="cpu", draw=False, weight_folder):
        # 
        self.detector = Detector(f"{weight_folder}/yolov8x_person_face.pt", device=device, verbose=verbose)
        self.age_gender_model = MiVOLO(
            f"{weight_folder}/model_imdb_cross_person_4.22_99.46.pth.tar",
            device=device,
            half=True,
            disable_faces=False,
            verbose=verbose,
